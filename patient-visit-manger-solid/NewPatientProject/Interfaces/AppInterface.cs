...
namespace NewPatientProject.Interfaces
{
    public interface IAdminInteraction
    {
        ...
        void CalculateAndViewPatientFeeRecord();
    ...
    public class Admin:IAdminInteraction
    {
        ...
        public FeeCalculator fee_calculator= new FeeCalculator();
        ...
        public void AddPatientRecord()
        {
            ...
            if (permission.ToLower() == "yes")
            {
                ...
                undo_redo_manager.AddUndoAction(patient, action);
        ...
        public void DeletePatientRecord()
        {
            ...
            record_manager.setAllPatientRecord(AllPatients);
            ///////////////////////////////////////////
            List<Patient> ToBeDeleted = AllPatients.Where(pat => pat.Name == patient_name).ToList();
            ...
            if (counter != 0)
            {
                ...
                updated_record_list = record_manager.DeletePatient(patient_name);
                    undo_redo_manager.AddUndoAction(ToBeDeleted[i], action);
                    undo_redo_manager.WriteUndoRecord();
                }
                file_manager.WritePatientRecord(updated_record_list);
        ...
        public void UpdatePatient()
        {
            ...
            List<Patient> updated_record_list=new List<Patient>();
            ///////////////////////////////////////
            List<Patient> ToBeUpdated = AllPatients.Where(p => p.Name == patient_name).ToList();
            ...
            if (counter > 0)
            {
                ...
                for (int i = 0; i < counter; i++)
                {
                    undo_redo_manager.AddUndoAction(ToBeUpdated[i], action);
        ...
        {
            undo_redo_manager.ReadFiles();
            undo_redo_manager.GetActionsFromStrings();
        ...
        public void RedoAction()
        {
            ...
            Console.WriteLine("To Redo an action on the Patient, Please enter the action Number ");
            int index = Convert.ToInt32(Console.ReadLine()) - 1;
        ...
        public void CalculateAndViewPatientFeeRecord()
        {
            file_manager.ReadFile();
            List<Patient> Patients = file_manager.PreparePatientObjectsFromFile();
            List<string> FeeRecord=fee_calculator.CalculateAndWriteFee(Patients);
